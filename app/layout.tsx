...
export const metadata: Metadata = {
	title: 'Rahardian Dewa Bimantara - Backend Engineer',
	description:
	...
	authors: [{ name: 'Rahardian Dewa Bimantara' }],
	creator: 'Rahardian Dewa Bimantara',
	openGraph: {
		title: 'Rahardian Dewa Bimantara - Backend Engineer Portfolio',
		...
		siteName: 'Rahardian Dewa Bimantara - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Rahardian Dewa Bimantara - Backend Engineer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
